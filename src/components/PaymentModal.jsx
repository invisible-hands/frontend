          ...
          <TEModalContent>
            ...
            <TEModalFooter className="flex justify-center">
              <TERipple rippleColor="light" rippleCentered>
                <button
                  type="button"
                  className="inline-block rounded bg-blue2 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-whitish transition duration-150 ease-in-out hover:bg-blue3 focus:bg-primary-accent-100 focus:outline-none focus:ring-0 active:bg-primary-accent-200"
                  onClick={() => setShowModal(false)}
                >
                  충전하기
                </button>
